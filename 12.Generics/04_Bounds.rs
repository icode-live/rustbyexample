// [12.4 Bounds](http://rustbyexample.com/generics/bounds.html)
/*
...
and so it requires T to be bound by Display;
...
/*
As an additional note, [where](http://rustbyexample.com/generics/where.html) clauses
