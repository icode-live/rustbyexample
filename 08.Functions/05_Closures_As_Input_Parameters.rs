...
When taking a closure as an input parameter, the closure's complete type must
be annotated using one of a few traits.
...
If the parameter is annotated as Fn, then capturing variables
