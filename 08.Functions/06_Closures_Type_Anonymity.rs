// [8.2.3 Type anonymity](http://rustbyexample.com/fn/closures/anonymity.html)
/*
...
the functionality via one of the traits: Fn, FnMut, or FnOnce for this unknown type.
