// [17.3 Strings](http://rustbyexample.com/std/str.html)
...
/*
More str/String methods can be found under
the [std::str](http://doc.rust-lang.org/std/str/)
and [std::string](http://doc.rust-lang.org/std/string/)  modules
*/
