// [13.4.1 Explicit annotation](http://rustbyexample.com/scope/lifetime/explicit.html)
/*
The borrow checker uses explicit lifetime annotations to determine how long
references should be valid. In cases where lifetimes are not elided
(elision implicitly annotates lifetimes and so is different),
Rust requires explicit annotations to determine what the lifetime of
...
exceed that of 'a. Explicit annotation of a type has the form &'a T where 'a
