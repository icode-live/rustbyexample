// [14.2 Operator Overloading](http://rustbyexample.com/trait/ops.html)
/*
...
Hence, the + operator can be used by any implementor of
the Add trait.

A list of the traits, such as Add, that overload operators
are available [here](http://doc.rust-lang.org/core/ops/) .
*/
