// [14.4 Iterators](http://rustbyexample.com/trait/iter.html)
/*
...
turns some collections into iterators using the .into_iterator()
method.

Methods that can be accessed using the Iterator trait in addition
to those shown in the example below can be found [here](http://doc.rust-lang.org/core/iter/trait.Iterator.html) .
*/
