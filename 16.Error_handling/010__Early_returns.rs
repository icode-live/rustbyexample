// [16.4.1 Early returns](http://rustbyexample.com/error/multiple_error_types/early_returns.html)
...
and early returns.
While we generally want to avoid panicking, explicitly handling all
of our errors is cumbersome.

In the next section, we'll introduce try! for the cases where we simply need
