// [16.3.2 aliases for Result](http://rustbyexample.com/error/result/result_alias.html)
/*
How about when we want to reuse a specific Result type many times?
Recall that Rust allows us to create [aliases](http://rustbyexample.com/cast/alias.html).
...
Errors found in a specific module often have the same Err type,
so a single alias can succinctly define all associated Results.
