// [16.4 Multiple error types](http://rustbyexample.com/error/multiple_error_types.html)
/*
...
our different error types in a way that makes them composable
...
handle errors. Since two different types of errors can occur, we need to convert
them to a common type such as a String.

To do so, we convert both the Option and Result into Results,
and then map their errors to the same type:
*/
...
/*
In the next section, we'll see an alternate method of explicitly handling
these errors.
*/
